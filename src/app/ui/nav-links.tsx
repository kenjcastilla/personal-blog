            ...
            {links.map((link) => {
                return (
                    <Link
                        ...
                        href={link.href}
                        className={
                            clsx("flex flex-row h-8 md:h-12 grow items-center justify-center gap-2 rounded-lg md:rounded-md p-3 text-sm md:text-md hover:bg-link_hover_gray dark:hover:bg-custom_gray md:flex-none md:justify-start md:p-2 md:px-3 md:text-md",
